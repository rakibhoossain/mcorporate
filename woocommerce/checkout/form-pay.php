	...
	<table class="shop_table">
		<thead>
			<tr>
				...
				<th class="product-quantity"><?php esc_html_e( 'Qty', 'mcorporate' ); ?></th>
				<th class="product-total"><?php esc_html_e( 'Totals', 'mcorporate' ); ?></th>
			</tr>
		</thead>
		<tbody>
